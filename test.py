...
def test(data,
    ...
    if not training or prun_val:
        ...
        dataloader = create_dataloader_rgb_ir(val_path_rgb, val_path_ir, imgsz, batch_size, gs, opt, pad=0.5,workers=8, rect=True,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch-size', type=int, default=55, help='size of each image batch') # 
