...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='/home/lilin/tangyujing/multispectral-object-detection/models/transformer/yolov5l_fusion_add_llvip.yaml', help='model.yaml')
